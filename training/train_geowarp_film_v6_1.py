"""
GeoWarpFiLMNet v6.1 training script
Fine-tune from v6 best checkpoint with lower lr.
Same loss as v6, just continue training from where v6 left off.
"""
import sys
...
config = {
    ...
    'output_dir':     'geowarp_film_v6_1',
    'checkpoint':     'geowarp_film_v6_1/best.net',
    'log_file':       'geowarp_film_v6_1/train.log',
    'pretrain':       'geowarp_film_v6/best.net',   # start from v6 best

    'stage1_epochs':  0,    # skip stage 1, go straight to stage 2
    'stage2_epochs':  50,
