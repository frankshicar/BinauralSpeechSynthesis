"""
GeoWarpFiLMNet v6 training script
v6 changes vs v5b:
- NeuralWarpCorrector: learns to correct geometric warpfield ITD underestimation (like Meta Warpnet)
- TemporalPositionEncoder: per-frame conditioning, each STFT frame has independent FiLM gamma/beta
  (v5b collapsed entire view into one vector - same conditioning for all frames, root cause of poor phase)
"""
import sys
...
config = {
    ...
    'output_dir':     'geowarp_film_v6',
    'checkpoint':     'geowarp_film_v6/best.net',
    'log_file':       'geowarp_film_v6/train.log',
